...
class Skin_File_Image extends Skin_Website {
	...
	protected function _register_controls_actions() {
        ...
        //add_action('elementor/element/ae-pods/image_general-style/before_section_end', [$this, 'register_style_control_extend']);
	}
    ...
    public function register_style_icon_controls(){
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    //'{{WRAPPER}} .ae-pods-overlay-block' => 'width: {{SIZE}}{{UNIT}};',
