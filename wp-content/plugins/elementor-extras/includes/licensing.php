...
return json_decode( '{"success":true, "license":"valid", "item_name":"' . urlencode( ELEMENTOR_EXTRAS_SL_ITEM_NAME ) . '", "license_limit":999, "site_count":1, "expires":"2048-06-06 23:59:59", "activations_left":998, "payment_id":12345, "customer_name":"Admin", "customer_email":"mail@server.com", "price_id":"1"}', true );
} elseif($action == "check_license") {
return json_decode( '{"success":true, "license":"valid", "item_name":"' . urlencode( ELEMENTOR_EXTRAS_SL_ITEM_NAME ) . '", "license_limit":999, "site_count":1, "expires":"2048-06-06 23:59:59", "activations_left":998, "payment_id":12345, "customer_name":"Admin", "customer_email":"mail@server.com", "price_id":"1"}', true );
}
	...
	public function activate_license() {
		...
		if ( empty( $_POST[ 'elementor_extras_license_key' ] ) ) {
			wp_die( __( 'Please enter your license key.', 'elementor-extras' ), __( 'Extras for Elementor', 'elementor-extras' ), [
				'back_link' => true,
			] );
		}
	...
	private function print_admin_notice( $title, $description, $action = null, $link = null, $dismissable = false ) {
		...
		?><div class="<?php echo $classes; ?>" <?php echo $data; ?>>
			<h3><?php printf( __( 'Extras for Elementor: %s' ), $title ); ?></h3>
			<p><?php
				echo $description;
