...
namespace Aepro\Modules\Taxonomy\Widgets;
...
class AeTaxonomy extends Widget_Base{
    ...
    protected function _register_controls() {
        Aepro::$_helper->ae_get_custom_taxonomies();
        ...
        $this->add_control(
            ...
            [
                ...
                'options'       => Aepro::$_helper->ae_get_custom_taxonomies(),
                'default'       => ''
            ]
        );
